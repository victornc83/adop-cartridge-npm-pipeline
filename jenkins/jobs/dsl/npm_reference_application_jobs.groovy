...
def referenceAppgitRepo = "ngx-admin"
def regressionTestGitRepo = "adop-cartridge-npm-regression-tests"
...
// Jobs
def pipelineAppJob = pipelineJob(projectFolderName + "/NPM_Reference_Application")
